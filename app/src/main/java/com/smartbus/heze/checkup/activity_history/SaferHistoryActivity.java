...
import com.smartbus.heze.checkup.presenter.SaferHistoryPresenter;
...
public class SaferHistoryActivity extends BaseActivity implements SaferHistoryContract.View {
    ...
    List<SaferHistory.ResultBean> beanList = new ArrayList<>();
    SaferHistoryPresenter saferHistoryPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatePicker();
        saferHistoryPresenter = new SaferHistoryPresenter(this, this);
        saferHistoryPresenter.getSaferHistory(tvStartTime.getText().toString()
    ...
    @Override
    public void setSaferHistory(SaferHistory s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<SaferHistory.ResultBean>(this, R.layout.adapter_check_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final SaferHistory.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(SaferHistoryActivity.this,SaferHistoryDetActivity.class);
    ...
    @Override
    public void setSaferHistoryMessage(String s) {

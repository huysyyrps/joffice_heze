...
import com.smartbus.heze.checkup.presenter.RCJCHistoryPresenter;
...
public class RCJCHistoryActivity extends BaseActivity implements RCJCHistoryContract.View {
    ...
    List<RCJCHistory.ResultBean> beanList = new ArrayList<>();
    RCJCHistoryPresenter rcjcHistoryPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatePicker();
        rcjcHistoryPresenter = new RCJCHistoryPresenter(this, this);
        rcjcHistoryPresenter.getRCJCHistory(tvStartTime.getText().toString()
    ...
    @Override
    public void setRCJCHistory(RCJCHistory s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<RCJCHistory.ResultBean>(this, R.layout.adapter_check_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final RCJCHistory.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(RCJCHistoryActivity.this,RCJCHistoryDetActivity.class);
    ...
    @Override
    public void setRCJCHistoryMessage(String s) {

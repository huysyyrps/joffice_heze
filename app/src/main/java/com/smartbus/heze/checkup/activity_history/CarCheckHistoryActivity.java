...
import com.smartbus.heze.checkup.presenter.CarCheckHistoryPresenter;
...
public class CarCheckHistoryActivity extends BaseActivity implements CarCehckHistoryContract.View {
    ...
    CarCheckHistoryPresenter carCheckHistoryPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatePicker();
        carCheckHistoryPresenter = new CarCheckHistoryPresenter(this, this);
        carCheckHistoryPresenter.getCarCehckHistory(tvStartTime.getText().toString()
            ...
            public void convert(BaseViewHolder holder, final CarCheckHistory.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CarCheckHistoryActivity.this,CarCheckHistoryDetActivity.class);

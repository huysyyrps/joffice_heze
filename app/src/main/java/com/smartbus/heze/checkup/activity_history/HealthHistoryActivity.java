...
import com.smartbus.heze.checkup.presenter.HistoryHistoryPresenter;
...
public class HealthHistoryActivity extends BaseActivity implements HealthHistoryContract.View {
    ...
    List<HealthHistory.ResultBean> beanList = new ArrayList<>();
    HistoryHistoryPresenter historyHistoryPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatePicker();
        historyHistoryPresenter = new HistoryHistoryPresenter(this, this);
        historyHistoryPresenter.getHealthHistory(tvStartTime.getText().toString()
    ...
    @Override
    public void setHealthHistory(HealthHistory s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<HealthHistory.ResultBean>(this, R.layout.adapter_check_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final HealthHistory.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(HealthHistoryActivity.this,HealthHistoryDetActivity.class);
    ...
    @Override
    public void setHealthHistoryMessage(String s) {

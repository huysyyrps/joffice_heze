...
public class WorkOnePersonAdapter extends BaseAdapter implements SectionIndexer {
    private List<WorkOnePersonDataBean> list = null;
    ...
    public interface CallBackPosition {
        void  myTextViewClient(WorkOnePersonDataBean department, String s);
    }
    ...
    public WorkOnePersonAdapter(Context mContext, List<WorkOnePersonDataBean> list) {
     ...
     * @param list
     */
    public void updateListView(List<WorkOnePersonDataBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final WorkOnePersonDataBean mContent = list.get(position);
        if (view == null) {

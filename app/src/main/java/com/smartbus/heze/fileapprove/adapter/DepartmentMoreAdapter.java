...
public class DepartmentMoreAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public interface CallBackPosition {
        void  myTextViewClient(DepartmentDataBean department, String s);
    }
    ...
    public DepartmentMoreAdapter(Context mContext, List<DepartmentDataBean> list) {

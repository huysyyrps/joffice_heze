...
public class DocumentLZList implements Serializable {
    ...
    public static class ResultBean {
         ...
         * lvMemo : 超级管理员(开始):; 测试1212(办公室):同意; 艾测试(总经理):同意; 测试201901(分管经理):同意;
         * lvProposedopinions :
         * lvInstructions :
         * lvResult :
         * fileIds :

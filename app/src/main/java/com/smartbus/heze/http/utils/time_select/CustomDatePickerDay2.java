 ...
 */
public class CustomDatePickerDay2 {
    ...
    public CustomDatePickerDay2(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initTimer() {
        ...
        if (spanYear) {
            ...
            for (int i = startMonth; i <= startMonth+1; i++) {
    ...
    private void monthChange() {
        ...
        if (selectedYear == startYear) {
            for (int i = startMonth; i <= startMonth; i++) {
                month.add(formatTimeUnit(i));
            }
        } else if (selectedYear == endYear) {
            for (int i = endMonth; i <= endMonth; i++) {
                month.add(formatTimeUnit(i));
            }
        } else {
            for (int i = startMonth; i <= endMonth; i++) {
